...
public class BrandResource {
     ...
     */
    @GetMapping("/brands")
    public ResponseEntity<List<Brand>> getAllBrands(BrandCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Brands by criteria: {}", criteria);
        Page<Brand> page = brandQueryService.findByCriteria(criteria, pageable);
